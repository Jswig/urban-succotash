...
var $author$project$View$placeholder = function (moduleName) {
	return {
		body: _List_fromArray(
			[
...
var $author$project$Page$Index$view = F3(
	function (maybeUrl, sharedModel, _static) {
		return $author$project$View$placeholder('Index');
	});
...
var $author$project$TemplateModulesBeta$templateSubscriptions = F3(
	function (route, path, model) {
		...
		if ((_v0.a.$ === 'ModelIndex') && (_v0.b.$ === 'Just')) {
					...
					var _v7 = _Utils_Tuple3(
						...
						A4(
							...
							A2(
								...
								model.current)));
					if (((_v7.a.$ === 'ModelIndex') && (_v7.b.$ === 'DataIndex')) && (_v7.c.$ === 'Just')) {
